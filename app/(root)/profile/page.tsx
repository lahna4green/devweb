  ...
  return (
    <>
      ...
      <section className="wrapper my-8">
        <Collection
          data={orderedEvents}
          emptyTitle="Aucun billet d'événement acheté pour le moment"
          emptyStateSubtext="Ne vous inquiétez pas, il y a plein d'événements passionnants à découvrir !"
